...
const MailSuccess = () => {
  return (
    <>
      <Breadcrumb title={"Mensaje Enviado"} pages={["Mensaje Enviado"]} />
          ...
          <div className="bg-white rounded-xl shadow-1 px-4 py-10 sm:py-15 lg:py-20 xl:py-25">
            <div className="text-center">
              ...
              <p className="max-w-[491px] w-full mx-auto mb-7.5">
                Gracias por tu mensaje. Revisamos el correo con frecuencia
                y haremos todo lo posible por responder a tu consulta.
              </p>
